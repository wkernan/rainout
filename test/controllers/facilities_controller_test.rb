...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { abbr: @facility.abbr, message: @facility.message, name: @facility.name, status: @facility.status }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { abbr: @facility.abbr, message: @facility.message, name: @facility.name, status: @facility.status }
    assert_redirected_to facility_path(assigns(:facility))
  end
